...
const Updateproduct = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="">
        <label className="my-2 font-semibold t text-lg">
          Enter a product Id for Update:{" "}
        </label>
        <input
          type="number"
          name="p_Id"
          value={product.p_Id}
          onChange={onChange}
          className="m-2 p-1 border-2 border-slate-200 rounded"
        />
        <button
          onClick={handleUpdate}
          className="bg-slate-900 text-white m-2 p-1 px-4 rounded"
        >
          Find Product
        </button>
      </div>
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="mb-3 flex flex-col">
              ...
              <input
                type="text"
                className="form-control border-2 border-slate-200 rounded mt-2 p-1"
                id="productname"
